...
/**
 * RIL customization for Samsung Grand Prime devices
 *
 * {@hide}
 */
public class SamsungFortunaRIL extends RIL implements CommandsInterface {
    ...
    public SamsungFortunaRIL(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
